...
const postData = [
  ...
  },
  {
    ...
    date_created: '11/13/2022',
    content_box:
      'A San Francisco classic! The banana splits are delicious, but too big for just one person. I love trying new flavors every time I visit. Just be prepared for the long wait in the chilly weather.',
  ...
  },
  {
    ...
    date_created: '11/13/2022',
    content_box:
      'The perfect happy hour spot! Enjoy drinks and dessert with an incredible view of the SF skyline.',
  ...
  },
  {
    ...
    date_created: '11/13/2022',
    content_box:
      'This brioche french toast with marscapone filling is my guilty pleasure. It is very rich so it really is a great treat to have every once in a while.',
  ...
  },
  {
    ...
    date_created: '11/13/2022',
    content_box:
      'The BEST mid-afternoon snack. Limón`s ceviche trio is always a good idea. Don`t forget to add a side of their yuca fries!',
  ...
  },
  {
    ...
    date_created: '11/13/2022',
    content_box:
      'Souvla is my favorite after-gym meal. It is light, and the ingredients are always fresh.',
